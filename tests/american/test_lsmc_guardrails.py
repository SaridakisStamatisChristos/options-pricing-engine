...
def test_american_put_above_euro_put(bs=black_scholes_price, lsmc=american_lsmc_price) -> None:
    params = {"spot": 100.0, "strike": 100.0, "tau": 0.5, "sigma": 0.25, "r": 0.01, "q": 0.0}
