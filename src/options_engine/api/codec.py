...
UNSUPPORTED_ERROR = ErrorMapping(_HTTP_422_UNPROCESSABLE_CONTENT, "unsupported_configuration")
...
IDEMPOTENCY_CONFLICT_ERROR = ErrorMapping(status.HTTP_409_CONFLICT, "idempotency_conflict")
